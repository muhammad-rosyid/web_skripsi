...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="page-section" id="pengendalidanpemantau">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">13 November 2020 | 21:06 WIB</h3>
                </div>
        ...
        <!-- Keluar-->
        <!-- <section class="page-section" id="Keluar">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Keluar</h2>
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3> -->
                <!-- </div>
                <form id="KeluarForm" name="sentMessage" novalidate="novalidate">
